...
class OrderMigration extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'pi_id'            => ['type' => 'int', 'constraint' => 11, 'null' => true],
            'pi_reference'     => ['type' => 'varchar', 'constraint' => 255],
            'pi_paid_at'       => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'pi_channel'       => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'pi_last4'         => ['type' => 'int', 'constraint' => 8, 'null' => true],
            'pi_card_type'     => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'pi_authorization_code'       => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
