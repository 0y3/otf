    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto">
                ...
                <li
                    class="nav-item dropdown <?=  ($currentMenu == 'restaurant') ? 'active' : '' ?> <?=  ($currentMenu == 'grocery') ? 'active' : '' ?> <?=  ($currentMenu == 'party') ? 'active' : '' ?>">
                ...
                <li class="nav-item dropdown <?php  ($currentMenu == 'account') ? 'active' : '' ?>">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">
                        <img alt="" src="<?=base_url("img/user/4.png")?>" class="nav-osahan-pic rounded-pill"></i>My
                        Account
                    </a>
                    <div class="dropdown-menu dropdown-menu-right shadow-sm border-0">
                        <a class="dropdown-item <?=  ($currentMenu == 'order') ? 'active' : '' ?>"
                        ...
                        <a class="dropdown-item" href="<?= site_url('logout')?>"><i class="icofont-logout"></i>
                            Logout</a>
                    </div>
                </li>
                <?php  else: ?>
