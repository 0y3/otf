    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-12 col-sm-12">
                ...
                <p><a class="text-info" href="register.html">Register now</a> to get updates on <a href="#">Offers and Coupons</a></p>
                <div class="app">
                    <p class="mb-2">DOWNLOAD APP</p>
                    <a href="#">
                    <img class="img-fluid" src="<?=base_url('img/google.png')?>">
                    </a>
                    <a href="#">
                    <img class="img-fluid" src="<?=base_url('img/apple.png')?>">
                    </a>
                </div>
            </div>
...
<footer class="pt-4 pb-4 text-center">
    <div class="container">
    <p class="mt-0 mb-0">&copy; Copyright <?php echo date('Y'); ?> OTF Eat. All Rights Reserved</p> 
    <small class="mt-0 mb-0"> Made with <i class="fas fa-heart heart-icon text-danger"></i> by
    <a class="text-danger" href="javascript:void(0);">Trovolink Tech</a> 
