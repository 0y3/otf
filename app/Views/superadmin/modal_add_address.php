...
<div class="modal fade" id="modal_address" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form id="modal_address_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="<?= site_url('otfadmin/add/address/'.$user->id)?>" method="POST">
                <!--begin::Modal header-->
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7">
                        ...
                        <div id="kt_modal_add_address_billing_info" class="collapse show" style="">
                            ...
                            <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                ...
                                <input class="form-control form-control-solid" placeholder="" name="address" required="required" value="">
