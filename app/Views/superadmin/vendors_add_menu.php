...
<div id="kt_content_container" class="container-xxl">
    ...
    <!--begin::Form-->
    <form id="newMenu_form" class="form newMenu_form" action="<?= route_to('menu_new',$biz->slug) ?>" method="post"
                ...
                <div class="fv-row card card-flush py-4 mb-md-5 mb-5">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <select name="status" class="form-select mb-2" data-control="select2" data-hide-search="true"
                            data-placeholder="Select an option" id="" required="required" value="">
                            <option></option>
                    ...
                    <div class="card-body pt-0">
                        <div class="fv-row">
                            ...
                            <select name="category" class="form-select mb-2" data-control="select2"
                                data-placeholder="Select an option" required="required" value="">
                                <option></option>
                                ...
                                <option value="<?=$data2['id']?>"> <?= ucwords($data2['name']) ?>
                                    <small>(<?= ucwords($data['name']) ?>)</small>
                                </option>
                                <?php endforeach;?>
                                <?php endif;?>
                                <?php endforeach;?>
                        ...
                        <!--end::Input group-->
                        <!--begin::Button-->
                        <a href="<?= route_to('menucategory', $biz->slug) ?>" id="test"
                ...
                <div class="card card-flush py-4 mb-md-5 mb-5">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name" class="form-control mb-2" required="required"
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="number" name="price" class="form-control mb-2" placeholder="Product price"
                                    ...
                                    <div class="mb-2" data-repeater-item>
                                        <div class="form-group row">
                                            <div class="col-md-10 col-xs-10">
                                                <div class="form-group row mt-3">
                                                    <div class="col-md-6">
                                                        <div class="mb-5">
                                                            ...
                                                            <h5 class="fw-bold form-text text-muted required">Add-Up
                                                                Menu Ctgy Name</h5>
                                                            <input type="text"
                                                                class="form-control form-control-lg mb-2 mb-md-0"
                                                                required="required" name="addupctgy"
                                                                placeholder="Addup Menu Ctgy name" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-5">
                                                            ...
                                                            <div class="btn-group btn-group-sm w-100 w-lg-50"
                                                                data-kt-buttons="true"
                                                                data-kt-buttons-target="[data-kt-button]">
                                                                <label
                                                                    class="btn btn-smm btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-success"
                                                                    data-kt-button="true">
                                                                    <input class="btn-checkk" checked="checked"
                                                                        type="radio" required="required"
                                                                        name="adduptype" value="radio button" />
                                                                    RadioButton
                                                                </label>
                                                                <label
                                                                    class="btn btn-smm btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-success"
                                                                    data-kt-button="true">
                                                                    <input class="btn-checkk" type="radio"
                                                                        required="required" name="adduptype"
                                                ...
                                                <div class="form-group row mt-3">
                                                    <label class="col-md-3 col-form-label text-right">Menu
                                                        Details</label>
                                                                    ...
                                                                    <div class="col-md-5 col-12">
                                                                        <div class="form-floating mb-2 mb-md-0">
                                                                            <input type="text"
                                                                                ...
                                                                                name="addupname" placeholder="" />
                                                                            <label class="required">Add-Up Menu
                                                                                Name</label>
                                                                        </div>
...
<script>
var biz_id = <?= json_encode($biz->id)?>;
var biz_isRest = "0";
</script>
<?php if ($biz->biz_type == VENDOR_REST) :?>
<script src="<?=base_url('admin/plugins/custom/formrepeater/formrepeater.bundle.js')?>"></script>
<script>
var biz_isRest = "1";
</script>
<?php endif ;?>
