...
<div id="kt_header" style="" class="header align-items-stretch">
   ...
   <div class="header-brand">
      <!--begin::Logo-->
      <a href="">
         <img alt="Logo" src="/img/logo.png" class="h-25px h-lg-25px" />
         <span class="text-white text-hover-primaryy fs-6 ps-1 fw-bold"> OTF Superadmin</span>
      </a>
      <!--end::Logo-->
   ...
   <div class="toolbar d-flex align-items-stretch">
      ...
      <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
         ...
         <div class="page-title d-flex justify-content-center flex-column me-5">
            <!--begin::Title-->
            <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">OTF Dashboard</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
               <!--begin::Item-->
               <li class="breadcrumb-item text-muted">
                  <a href="<?=site_url('otfadmin/dashboard') ?>" class="text-muted text-hover-primary">Dashboards</a>
               </li>
               <!--end::Item-->
